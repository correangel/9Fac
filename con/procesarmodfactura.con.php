...
$datosFactura["IdFactura"] = $_POST["IdFactura"];
...
$sql = "UPDATE ges_facturas SET SerieFactura=%SerieFactura%,".
	"NFactura=%NFactura%,FechaFactura=%FechaFactura%,IdCliente=%IdCliente%,
	...
	" ObraRealizada=%ObraRealizada% WHERE IdFactura=%IdFactura%  ";
...
$IdFactura = CleanID($_POST["IdFactura"]);
...
query("DELETE FROM ges_facturas_det WHERE IdFactura='$IdFactura'");
