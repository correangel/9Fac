...
$datosPedido["IdPedido"] = $_POST["IdPedido"];
...
$sql = "UPDATE ges_pedidos SET SeriePedido=%SeriePedido%,".
	"NPedido=%NPedido%,FechaPedido=%FechaPedido%,IdCliente=%IdCliente%,
		    ImporteNeto=%ImporteNeto%,IvaImporte=%IvaImporte%,TotalImporte=%TotalImporte%,
		     SerieNumeroPedido=%SerieNumeroPedido%,
			NombreComercial=%NombreComercial%,Direccion=%Direccion%,Poblacion=%Poblacion%,CIF=%CIF%,CodigoPostal=%CodigoPostal%, ".
	" ObraRealizada=%ObraRealizada% WHERE IdPedido=%IdPedido%  ";
...
$IdPedido = CleanID($_POST["IdPedido"]);
...
query("DELETE FROM ges_pedidos_det WHERE IdPedido='$IdPedido'");
