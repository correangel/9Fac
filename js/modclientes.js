...
var moduloAjax ="modclientes.php";
...
function AjaxCargarUsuario(IdUsuario){
	...
	var url = moduloAjax + "?modo=JSONCargarCliente&IdCliente="+IdUsuario;
...
function UpdateUser(){
	...
	xnombreUsuario = id("NombreComercial");
	...
	data =  data + "IdCliente=" + editandoIdUsuario  +cr;		
...
//	data =  data + "IdModPagoHabitual=" + encodeURIComponent(id("IdModPagoHabitual").value) + cr;
	...
	data = data + "modo="+ "modificarcliente"+ cr;
