...
include("inc/modalbarans.inc.php");

StartXul("modalbarans",false,false,true);
...
<popupset>
  <popup id="accionesLista" class="media">
	   <menuitem class="menuitem-iconic" image="img/addcart16.gif" label="Quitar"  oncommand="quitarElementoAlbaran(this)"/>
  </popup>
	...
	<toolbar id="a-toolbar" >
		...
		<toolbarbutton image="img/busca1.gif" label="Buscar" oncommand="Accion_BuscarAlbaran()"/>
	</toolbar>


<groupbox flex="1">
<caption id="captionclick" >
<description>Cabecera de albaran</description>
<vbox><spacer flex="1"/>
...
<hbox align="center">
<label class="labelGeneral">Nº Albaran:</label>
<textbox disabled="true" value="" class="datoNumalbaran" id="datoNumalbaran" flex="0"/>
<toolbarbutton  image="img/edit.png"  oncommand="habilitarEdicion('datoNumalbaran')" collapsed="false"/>
<toolbarbutton  image="img/addnew.gif"  oncommand="CargarSiguientesDatosDeAlbaran()"  zoncommand="AbrirVentanaNumalbaran()" collapsed="false"/>
<spacer flex="1"/>
</hbox>

<hbox align="center">
<label class="labelGeneral">Fecha Albaran:</label>
...
<vbox>
<label value="Total Albaran" style="font-weight: bold"/>
<textbox id="totalalbaran" value="" style="text-align: right;color:gray" readonly="true"/>
</vbox>

</hbox>
</groupbox>
<hbox  id="cajaModoModificacion" collapsed="true">
    <button image="img/printicon.png" label="Imprimir" oncommand="VentanaImprimirAlbaran()"/>
...
<hbox id="cajaModoAlta">
    <spacer flex="1"/>
    <button image="img/enviar.png" label="Crear albaran" oncommand="EnviarAlbaran()"/>
    <button image="img/button_cancel.png" label="Cancelar albaran" oncommand="CancelarAlbaran()"/>
</hbox>
...
Albaran.numero = 3;
Albaran.serie = "A";
Albaran.numeroalbaran= "A-3";
Albaran.fecha = "<?php echo date("d-m-Y") ?>";
Albaran.IdCliente = 0;
Albaran.IdAlbaran = 0;

]]></script>
<script type="application/x-javascript" src="js/modalbarans.js?ver=1/<?php echo rand(0,99999999); ?>"/>
