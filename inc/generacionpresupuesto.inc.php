...
include("inc/presupuestos.inc.php");
include("inc/facturas.inc.php");
//include("inc/negocio.inc.php");

echo str_replace("#","?",'<#xml version="1.0" encoding="UTF-8"#>');


$IdPresupuesto = CleanID($_REQUEST["id"]);

$d = queryrow("SELECT * FROM ges_presupuestos WHERE IdPresupuesto='$IdPresupuesto'");


$row = DatosNegocio();
$IdFormato = $row["IdTipoNumeracionFactura"];

$serie = $d["SeriePresupuesto"];
$numero = $d["NPresupuesto"];


$numeroseriepresupuesto = getFacturaFormateada($serie,$numero,$IdFormato);

$numeroseriepresupuesto = $d["SerieNumeroPresupuesto"];
...
$htmlLineasPresupuesto = $out;


$totalMasIva = $componente;
$totalIva = $totalMasIva * 0.16;
$totalPresupuesto = $totalMasIva - $totalIva;
...
<tr><td width="60%"></td><td>NºPRESUPUESTO</td><td width="10%"></td><td><p align="right"><?php echo html($numeroseriepresupuesto) ?></p></td></tr>
<tr><td></td><td>FECHA</td><td></td><td><p align="right"><?php echo CleanFechaFromDB($d["FechaPresupuesto"]) ?></p></td></tr>
...
<?php echo  $htmlLineasPresupuesto; ?>

<tr><td colspan="3"><hr></td><tr>
<tr><td></td><td><p align="right"><nobr>Importe Neto: </nobr></p></td><td><p align="right"><nobr><?php echo PrintMoney($totalPresupuesto) ?> &euro;</nobr></p></td><tr>
...
<p><small>No se olvide de especificar el nº de presupuesto en la transferencia.</small></p>
