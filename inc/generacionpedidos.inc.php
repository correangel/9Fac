...
$IdPedido = CleanID($_REQUEST["id"]);

$d = queryrow("SELECT * FROM ges_pedidos WHERE IdPedido='$IdPedido'");


$row = DatosNegocio();
//$serie = $row["SerieDefecto"];
$IdFormato = $row["IdTipoNumeracionPedido"];

$serie = $d["SeriePedido"];
$numero = $d["NPedido"];
$IdFormato = $row["IdTipoNumeracionPedido"];

$numeroseriepedido = getPedidoFormateada($serie,$numero,$IdFormato);

$numeroseriepedido = $d["SerieNumeroPedido"];
...
$htmlLineasPedido = $out;


$totalMasIva = $componente;
$totalIva = $totalMasIva * 0.16;
$totalPedido = $totalMasIva - $totalIva;
...
<tr><td width="60%"></td><td>NºFACTURA</td><td width="10%"></td><td><p align="right"><?php echo html($numeroseriepedido) ?></p></td></tr>
<tr><td></td><td>FECHA</td><td></td><td><p align="right"><?php echo CleanFechaFromDB($d["FechaPedido"]) ?></p></td></tr>
...
<?php echo  $htmlLineasPedido; ?>

<tr><td colspan="3"><hr></td><tr>
<tr><td></td><td><p align="right"><nobr>Importe Neto: </nobr></p></td><td><p align="right"><nobr><?php echo PrintMoney($totalPedido) ?> &euro;</nobr></p></td><tr>
...
<p><small>No se olvide de especificar el nº de pedido en la transferencia.</small></p>
