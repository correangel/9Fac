...
$IdFactura = CleanID($_REQUEST["id"]);

$d = queryrow("SELECT * FROM ges_facturas WHERE IdFactura='$IdFactura'");
...
$serie = $d["SerieFactura"];
$numero = $d["NFactura"];
$IdFormato = $row["IdTipoNumeracionFactura"];

$numeroseriefactura = getFacturaFormateada($serie,$numero,$IdFormato);

$numeroseriefactura = $d["SerieNumeroFactura"];
...
$htmlLineasFactura = $out;


$totalMasIva = $componente;
$totalIva = $totalMasIva * 0.16;
$totalFactura = $totalMasIva - $totalIva;
...
<tr><td width="60%"></td><td>NºFACTURA</td><td width="10%"></td><td><p align="right"><?php echo html($numeroseriefactura) ?></p></td></tr>
<tr><td></td><td>FECHA</td><td></td><td><p align="right"><?php echo CleanFechaFromDB($d["FechaFactura"]) ?></p></td></tr>
...
<?php echo  $htmlLineasFactura; ?>

<tr><td colspan="3"><hr></td><tr>
<tr><td></td><td><p align="right"><nobr>Importe Neto: </nobr></p></td><td><p align="right"><nobr><?php echo PrintMoney($totalFactura) ?> &euro;</nobr></p></td><tr>
...
<p><small>No se olvide de especificar el nº de factura en la transferencia.</small></p>
