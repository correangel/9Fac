...
echo str_replace("@","?","<@xml-stylesheet href='chrome://global/skin/global.css' type='text/css'@>");
echo str_replace("@","?","<@xml-stylesheet href='datepicker.css' type='text/css'@>");
...
<vbox id="oe-date-picker-overlay-box" >
   ...
   <!-- Year controls -->
      <hbox id="oe-date-picker-year-controls-box"  >
         ...
         <box flex="1">   
            <image src="complementos/datepicker/skin/arrow.gif" onclick="oeDatePicker.previousYearCommand()"/>
         </box>
                
         <label id="oe-date-picker-year-title-text" value="" />
        
         <box flex="1" id="oe-date-picker-year-next-button-box" >
            <image src="complementos/datepicker/skin/arrow2.gif" onclick="oeDatePicker.nextYearCommand()"/> 
         </box>  
        ...
        <rows >
            ...
            <row flex="1"  >
                <vbox class="oe-date-picker-year-month-box-class" id="oe-date-picker-year-month-9-box"  onclick="oeDatePicker.clickMonth(this, 9)" >
                    <spacer flex="1" />
                    <box><label  class="oe-date-picker-year-month-name-class"  value="Septiembre" /></box> 
                    <spacer flex="1" />
                </vbox>  
                <vbox class="oe-date-picker-year-month-box-class"  id="oe-date-picker-year-month-10-box" onclick="oeDatePicker.clickMonth(this, 10)" >
                    <spacer flex="1" />
                    <box><label  class="oe-date-picker-year-month-name-class"  value="Octubre" /></box> 
                    <spacer flex="1" />
                </vbox>  
                <vbox class="oe-date-picker-year-month-box-class" id="oe-date-picker-year-month-11-box"  onclick="oeDatePicker.clickMonth(this, 11)" >
                    <spacer flex="1" />
                    <box><label  class="oe-date-picker-year-month-name-class"  value="Noviembre" /></box> 
                    <spacer flex="1" />
                </vbox>  
                <vbox class="oe-date-picker-year-month-box-class" id="oe-date-picker-year-month-12-box"  onclick="oeDatePicker.clickMonth(this, 12)" >
                    <spacer flex="1" />
                    <box><label  class="oe-date-picker-year-month-name-class"  value="Diciembre" /></box> 
                    <spacer flex="1" />
                </vbox>  
            </row>  
