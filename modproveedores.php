...
include_once("inc/proveedores.inc.php");	
...
<listbox  flex="1" id="listadoProveedores">
</listbox>
</groupbox>
<groupbox flex="4">
...
<hbox align="center">
	...
	<description style="font-size: 120%">GESTION DE PROVEEDORES</description>
	<spacer flex="1"/>
</hbox>
...
<caption label="Nuevo"/>
<hbox>	
	<button image="img/addcliente.png" label="Nuevo proveedor" oncommand="AddNewUser()"/>
	<textbox id="nombreProveedorAlta" value=""/>	
	<spacer flex="1"/>
</hbox>
</groupbox>
...
<groupbox id="ModificandoProveedor" pack="center" flex="1">
<caption label="Editar"/>

<hbox flex="1">
<vbox flex="1"> 
<hbox collapsed="true"><checkbox id="activo" label="Cuenta activada"/></hbox>
...
<script type="application/x-javascript" src="js/modproveedores.js?ver=1/<?php echo rand(0,99999999); ?>"/>
<script>//<![CDATA[
